...
const MobileGrid = dynamic(() => import("@/components/skills/MobileGrid"));
...
type TabId = "Frontend" | "Backend" | "Mobile" | "AI/ML" | "Databases" | "Testing" | "DevOps" | "Cloud";
...
export default function Skills() {
    ...
    return (
        <Section id="skills" title="Technical Skills & Tools" subtitle="Breadth and depth across the stack">
                    ...
                    {tabs.map((t) => {
                        ...
                        return (
                            <button
                                ...
                                className={`px-3 py-1.5 text-sm rounded-md border transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--sky)] ${isActive ? "btn-accent border-transparent" : "bg-white text-[var(--teal)] border-default hover:bg-[var(--sky)]/30"}`}
